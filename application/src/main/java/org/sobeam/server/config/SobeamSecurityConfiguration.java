...
import org.sobeam.server.service.security.auth.jwt.JwtAuthenticationProvider;
import org.sobeam.server.service.security.auth.jwt.JwtTokenAuthenticationProcessingFilter;
import org.sobeam.server.service.security.auth.jwt.RefreshTokenAuthenticationProvider;
import org.sobeam.server.service.security.auth.jwt.RefreshTokenProcessingFilter;
import org.sobeam.server.service.security.auth.jwt.SkipPathRequestMatcher;
import org.sobeam.server.service.security.auth.jwt.extractor.TokenExtractor;
import org.sobeam.server.service.security.auth.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import org.sobeam.server.service.security.auth.rest.RestAuthenticationProvider;
import org.sobeam.server.service.security.auth.rest.RestLoginProcessingFilter;
import org.sobeam.server.service.security.auth.rest.RestPublicLoginProcessingFilter;
...
@TbCoreComponent
public class SobeamSecurityConfiguration {
    ...
    @Autowired
    private SobeamErrorResponseHandler restAccessDeniedHandler;
