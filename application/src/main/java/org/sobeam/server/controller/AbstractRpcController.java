...
import org.sobeam.server.service.rpc.LocalRequestMetaData;
...
public abstract class AbstractRpcController extends BaseController {
    ...
    protected DeferredResult<ResponseEntity> handleDeviceRPCRequest(boolean oneWay, DeviceId deviceId, String requestBody, HttpStatus timeoutStatus, HttpStatus noActiveConnectionStatus) throws SobeamException {
        try {
            ...
            throw new SobeamException("Invalid request body", ioe, SobeamErrorCode.BAD_REQUEST_PARAMS);
        }
    }
