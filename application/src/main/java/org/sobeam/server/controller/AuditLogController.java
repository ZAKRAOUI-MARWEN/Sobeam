...
import static org.sobeam.server.controller.ControllerConstants.AUDIT_LOG_TEXT_SEARCH_DESCRIPTION;
...
public class AuditLogController extends BaseController {
    ...
    public PageData<AuditLog> getAuditLogsByCustomerId(
            ...
            @RequestParam(name = "actionTypes", required = false) String actionTypesStr) throws SobeamException {
