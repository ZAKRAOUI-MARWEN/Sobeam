...
import static org.sobeam.server.controller.ControllerConstants.CUSTOMER_TEXT_SEARCH_DESCRIPTION;
...
public class CustomerController extends BaseController {
    ...
    public Customer getCustomerById(
            ...
            @PathVariable(CUSTOMER_ID) String strCustomerId) throws SobeamException {
    ...
    public Customer getTenantCustomer(
            ...
            @RequestParam String customerTitle) throws SobeamException {
            TenantId tenantId = getCurrentUser().getTenantId();
