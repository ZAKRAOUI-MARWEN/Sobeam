...
import org.sobeam.server.common.data.HomeDashboard;
import org.sobeam.server.common.data.HomeDashboardInfo;
...
import org.sobeam.server.service.entitiy.dashboard.TbDashboardService;
...
import static org.sobeam.server.controller.ControllerConstants.DASHBOARD_TEXT_SEARCH_DESCRIPTION;
...
import static org.sobeam.server.controller.ControllerConstants.EDGE_ID;
...
import static org.sobeam.server.controller.ControllerConstants.INLINE_IMAGES;
import static org.sobeam.server.controller.ControllerConstants.INLINE_IMAGES_DESCRIPTION;
...
public class DashboardController extends BaseController {
    ...
    public long getServerTime() throws SobeamException {
    ...
    public long getMaxDatapointsLimit() throws SobeamException {
    ...
    public DashboardInfo getDashboardInfoById(
            ...
            @PathVariable(DASHBOARD_ID) String strDashboardId) throws SobeamException {
    ...
    public Dashboard getDashboardById(
            ...
            @RequestParam(value = INLINE_IMAGES, required = false) boolean inlineImages) throws SobeamException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
    ...
    public Dashboard updateDashboardCustomers(
            ...
            @RequestBody(required = false) String[] strCustomerIds) throws SobeamException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
        Dashboard dashboard = checkDashboardId(dashboardId, Operation.ASSIGN_TO_CUSTOMER);
    ...
    public Dashboard addDashboardCustomers(
            ...
            @RequestBody String[] strCustomerIds) throws SobeamException {
        checkParameter(DASHBOARD_ID, strDashboardId);
        DashboardId dashboardId = new DashboardId(toUUID(strDashboardId));
        Dashboard dashboard = checkDashboardId(dashboardId, Operation.ASSIGN_TO_CUSTOMER);
        Set<CustomerId> customerIds = customerIdFromStr(strCustomerIds);
    ...
    @ResponseBody
    public HomeDashboard getHomeDashboard() throws SobeamException {
    ...
    @ResponseBody
    public HomeDashboardInfo getHomeDashboardInfo() throws SobeamException {
        SecurityUser securityUser = getCurrentUser();
        if (securityUser.isSystemAdmin()) {
            return null;
        }
    ...
    @ResponseBody
    public HomeDashboardInfo getTenantHomeDashboardInfo() throws SobeamException {
    ...
    public void setTenantHomeDashboardInfo(
            ...
            @RequestBody HomeDashboardInfo homeDashboardInfo) throws SobeamException {
