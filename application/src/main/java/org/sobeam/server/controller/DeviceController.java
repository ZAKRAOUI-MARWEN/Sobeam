...
import org.sobeam.server.common.data.device.DeviceSearchQuery;
...
import org.sobeam.server.service.device.DeviceBulkImportService;
import org.sobeam.server.service.entitiy.device.TbDeviceService;
...
import static org.sobeam.server.controller.ControllerConstants.CUSTOMER_AUTHORITY_PARAGRAPH;
import static org.sobeam.server.controller.ControllerConstants.CUSTOMER_ID;
import static org.sobeam.server.controller.ControllerConstants.CUSTOMER_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_ACTIVE_PARAM_DESCRIPTION;
...
import static org.sobeam.server.controller.ControllerConstants.DEVICE_INFO_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_NAME_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_PROFILE_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_TEXT_SEARCH_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_TYPE_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_ACCESS_TOKEN_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_LVM2M_RPK_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_MQTT_BASIC_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_UPDATE_CREDENTIALS_PARAM_X509_CERTIFICATE_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_ACCESS_TOKEN_DEFAULT_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_ACCESS_TOKEN_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_LVM2M_RPK_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_MQTT_BASIC_DESCRIPTION_MARKDOWN;
import static org.sobeam.server.controller.ControllerConstants.DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_X509_CERTIFICATE_DESCRIPTION_MARKDOWN;
...
import static org.sobeam.server.controller.ControllerConstants.TENANT_ID;
import static org.sobeam.server.controller.ControllerConstants.TENANT_ID_PARAM_DESCRIPTION;
...
public class DeviceController extends BaseController {
    ...
    public Device getDeviceById(@Parameter(description = DEVICE_ID_PARAM_DESCRIPTION)
                                @PathVariable(DEVICE_ID) String strDeviceId) throws SobeamException {
    ...
    public Device saveDeviceWithCredentials(@Parameter(description = "The JSON object with device and credentials. See method description above for example.")
                                            @Valid @RequestBody SaveDeviceWithCredentialsRequest deviceAndCredentials) throws SobeamException {
    ...
    public DeviceCredentials updateDeviceCredentials(
            ...
            @RequestBody DeviceCredentials deviceCredentials) throws SobeamException {
    ...
    public Device getTenantDevice(
            ...
            @RequestParam String deviceName) throws SobeamException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    public List<Device> getDevicesByIds(
            ...
            @RequestParam("deviceIds") String[] strDeviceIds) throws SobeamException, ExecutionException, InterruptedException {
    ...
    public List<Device> findByQuery(
            ...
            @RequestBody DeviceSearchQuery query) throws SobeamException, ExecutionException, InterruptedException {
        checkNotNull(query);
    ...
    public List<EntitySubtype> getDeviceTypes() throws SobeamException, ExecutionException, InterruptedException {
        SecurityUser user = getCurrentUser();
        TenantId tenantId = user.getTenantId();
    ...
    public DeferredResult<ResponseEntity> claimDevice(@Parameter(description = "Unique name of the device which is going to be claimed")
                                                      ...
                                                      @RequestBody(required = false) ClaimRequest claimRequest) throws SobeamException {
    ...
    public DeferredResult<ResponseEntity> reClaimDevice(@Parameter(description = "Unique name of the device which is going to be reclaimed")
                                                        @PathVariable(DEVICE_NAME) String deviceName) throws SobeamException {
        checkParameter(DEVICE_NAME, deviceName);
        final DeferredResult<ResponseEntity> deferredResult = new DeferredResult<>();
    ...
    public Device assignDeviceToTenant(@Parameter(description = TENANT_ID_PARAM_DESCRIPTION)
        ...
        if (newTenant == null) {
            throw new SobeamException("Could not find the specified Tenant!", SobeamErrorCode.BAD_REQUEST_PARAMS);
        }
    ...
    public Long countByDeviceProfileAndEmptyOtaPackage(
            ...
            @PathVariable("deviceProfileId") String deviceProfileId) throws SobeamException {
