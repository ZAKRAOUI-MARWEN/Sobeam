...
import org.sobeam.server.common.data.entityview.EntityViewSearchQuery;
...
import static org.sobeam.server.controller.ControllerConstants.ENTITY_VIEW_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.ENTITY_VIEW_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.ENTITY_VIEW_INFO_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.ENTITY_VIEW_TEXT_SEARCH_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.ENTITY_VIEW_TYPE;
import static org.sobeam.server.controller.ControllerConstants.MODEL_DESCRIPTION;
...
public class EntityViewController extends BaseController {
    ...
    public EntityView getEntityViewById(
            ...
            @PathVariable(ENTITY_VIEW_ID) String strEntityViewId) throws SobeamException {
    ...
    public EntityView getTenantEntityView(
            ...
            @RequestParam String entityViewName) throws SobeamException {
    ...
    public List<EntityView> findByQuery(
            ...
            @RequestBody EntityViewSearchQuery query) throws SobeamException, ExecutionException, InterruptedException {
        checkNotNull(query);
    ...
    @ResponseBody
    public List<EntitySubtype> getEntityViewTypes() throws SobeamException, ExecutionException, InterruptedException {
