...
import org.sobeam.server.common.data.notification.targets.NotificationTargetConfig;
...
public class NotificationTargetController extends BaseController {
    ...
    @PreAuthorize("hasAnyAuthority('SYS_ADMIN', 'TENANT_ADMIN')")
    public NotificationTarget getNotificationTargetById(@PathVariable UUID id) throws SobeamException {
    ...
    private void checkTargetUsers(SecurityUser user, NotificationTargetConfig targetConfig) throws SobeamException {
