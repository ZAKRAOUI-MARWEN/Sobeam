...
import org.sobeam.server.service.entitiy.ota.TbOtaPackageService;
...
import static org.sobeam.server.controller.ControllerConstants.OTA_PACKAGE_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.OTA_PACKAGE_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.OTA_PACKAGE_INFO_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.OTA_PACKAGE_TEXT_SEARCH_DESCRIPTION;
...
public class OtaPackageController extends BaseController {
    ...
    public ResponseEntity<org.springframework.core.io.Resource> downloadOtaPackage(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                                                                   @PathVariable(OTA_PACKAGE_ID) String strOtaPackageId) throws SobeamException {
    ...
    public OtaPackageInfo saveOtaPackageInfo(@Parameter(description = "A JSON value representing the OTA Package.")
                                             @RequestBody SaveOtaPackageInfoRequest otaPackageInfo) throws SobeamException {
    ...
    public OtaPackageInfo saveOtaPackageData(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                             ...
                                             @RequestPart MultipartFile file) throws SobeamException, IOException {
        checkParameter(OTA_PACKAGE_ID, strOtaPackageId);
    ...
    public void deleteOtaPackage(@Parameter(description = OTA_PACKAGE_ID_PARAM_DESCRIPTION)
                                 @PathVariable("otaPackageId") String strOtaPackageId) throws SobeamException {
        checkParameter(OTA_PACKAGE_ID, strOtaPackageId);
        OtaPackageId otaPackageId = new OtaPackageId(toUUID(strOtaPackageId));
