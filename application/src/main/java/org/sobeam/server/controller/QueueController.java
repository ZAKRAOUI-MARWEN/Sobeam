...
import static org.sobeam.server.controller.ControllerConstants.QUEUE_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.QUEUE_NAME_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.QUEUE_QUEUE_TEXT_SEARCH_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.QUEUE_SERVICE_TYPE_DESCRIPTION;
...
public class QueueController extends BaseController {
    ...
    public Queue getQueueById(@Parameter(description = QUEUE_ID_PARAM_DESCRIPTION)
                              @PathVariable("queueId") String queueIdStr) throws SobeamException {
    ...
    public Queue getQueueByName(@Parameter(description = QUEUE_NAME_PARAM_DESCRIPTION)
                                @PathVariable("queueName") String queueName) throws SobeamException {
    ...
    public Queue saveQueue(@Parameter(description = "A JSON value representing the queue.")
                           ...
                           @RequestParam String serviceType) throws SobeamException {
        checkParameter("serviceType", serviceType);
