...
import static org.sobeam.server.controller.ControllerConstants.QUEUE_STATS_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.QUEUE_STATS_TEXT_SEARCH_DESCRIPTION;
...
public class QueueStatsController extends BaseController {
    ...
    public QueueStats getQueueStatsById(@Parameter(description = QUEUE_STATS_ID_PARAM_DESCRIPTION)
                                        @PathVariable("queueStatsId") String queueStatsIdStr) throws SobeamException {
    ...
    public List<QueueStats> getQueueStatsByIds(
            ...
            @RequestParam("queueStatsIds") String[] strQueueStatsIds) throws SobeamException {
