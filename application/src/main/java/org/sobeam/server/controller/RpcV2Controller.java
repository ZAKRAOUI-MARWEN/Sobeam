...
import static org.sobeam.server.controller.ControllerConstants.RPC_ID;
import static org.sobeam.server.controller.ControllerConstants.RPC_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.RPC_TEXT_SEARCH_DESCRIPTION;
...
public class RpcV2Controller extends AbstractRpcController {
    ...
    public DeferredResult<ResponseEntity> handleOneWayDeviceRPCRequest(
            ...
            @RequestBody String requestBody) throws SobeamException {
    ...
    public Rpc getPersistedRpc(
            ...
            @PathVariable(RPC_ID) String strRpc) throws SobeamException {
