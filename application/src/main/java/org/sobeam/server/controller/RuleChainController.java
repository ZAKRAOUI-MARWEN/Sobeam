...
import org.sobeam.server.common.data.page.PageDataIterableByTenant;
import org.sobeam.server.common.data.page.PageLink;
import org.sobeam.server.common.data.rule.DefaultRuleChainCreateRequest;
import org.sobeam.server.common.data.rule.RuleChain;
import org.sobeam.server.common.data.rule.RuleChainData;
import org.sobeam.server.common.data.rule.RuleChainImportResult;
import org.sobeam.server.common.data.rule.RuleChainMetaData;
import org.sobeam.server.common.data.rule.RuleChainOutputLabelsUsage;
...
import org.sobeam.server.service.script.RuleNodeJsScriptEngine;
import org.sobeam.server.service.script.RuleNodeTbelScriptEngine;
...
import static org.sobeam.server.controller.ControllerConstants.RULE_CHAIN_TEXT_SEARCH_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.RULE_CHAIN_TYPE_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.RULE_NODE_ID_PARAM_DESCRIPTION;
...
public class RuleChainController extends BaseController {
    ...
    public RuleChain getRuleChainById(
            ...
            @PathVariable(RULE_CHAIN_ID) String strRuleChainId) throws SobeamException {
    ...
    public JsonNode getLatestRuleNodeDebugInput(
            ...
            @PathVariable(RULE_NODE_ID) String strRuleNodeId) throws SobeamException {
    ...
    public JsonNode testScript(
            ...
            @RequestBody JsonNode inputParams) throws SobeamException, JsonProcessingException {
    ...
    public RuleChainData exportRuleChains(
            ...
            @RequestParam("limit") int limit) throws SobeamException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    public List<RuleChainImportResult> importRuleChains(
            ...
            @RequestParam(required = false, defaultValue = "false") boolean overwrite) throws SobeamException {
        TenantId tenantId = getCurrentUser().getTenantId();
    ...
    @ResponseBody
    public List<RuleChain> getAutoAssignToEdgeRuleChains() throws SobeamException {
        TenantId tenantId = getCurrentUser().getTenantId();
