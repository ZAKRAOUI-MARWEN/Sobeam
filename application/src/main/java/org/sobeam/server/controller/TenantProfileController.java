...
import static org.sobeam.server.controller.ControllerConstants.TENANT_PROFILE_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.TENANT_PROFILE_TEXT_SEARCH_DESCRIPTION;
...
public class TenantProfileController extends BaseController {
    ...
    public TenantProfile getTenantProfileById(
            ...
            @PathVariable("tenantProfileId") String strTenantProfileId) throws SobeamException {
    ...
    @ResponseBody
    public EntityInfo getDefaultTenantProfileInfo() throws SobeamException {
    ...
    public TenantProfile saveTenantProfile(@Parameter(description = "A JSON value representing the tenant profile.")
                                           @RequestBody TenantProfile tenantProfile) throws SobeamException {
