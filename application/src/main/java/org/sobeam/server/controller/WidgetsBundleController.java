...
import org.sobeam.server.service.entitiy.widgets.bundle.TbWidgetsBundleService;
...
import static org.sobeam.server.controller.ControllerConstants.WIDGET_BUNDLE_ID_PARAM_DESCRIPTION;
import static org.sobeam.server.controller.ControllerConstants.WIDGET_BUNDLE_TEXT_SEARCH_DESCRIPTION;
...
public class WidgetsBundleController extends BaseController {
    ...
    public void deleteWidgetsBundle(
            @Parameter(description = WIDGET_BUNDLE_ID_PARAM_DESCRIPTION, required = true)
            @PathVariable("widgetsBundleId") String strWidgetsBundleId) throws SobeamException {
        checkParameter("widgetsBundleId", strWidgetsBundleId);
        WidgetsBundleId widgetsBundleId = new WidgetsBundleId(toUUID(strWidgetsBundleId));
    ...
    public PageData<WidgetsBundle> getWidgetsBundles(
            ...
            @RequestParam(required = false) Boolean fullSearch) throws SobeamException {
    ...
    @ResponseBody
    public List<WidgetsBundle> getWidgetsBundles() throws SobeamException {
        if (Authority.SYS_ADMIN.equals(getCurrentUser().getAuthority())) {
