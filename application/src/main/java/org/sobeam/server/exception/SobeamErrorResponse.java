...
@Schema
public class SobeamErrorResponse {
    ...
    // Error code
    private final SobeamErrorCode errorCode;

    private final long timestamp;

    protected SobeamErrorResponse(final String message, final SobeamErrorCode errorCode, HttpStatus status) {
    ...
    public static SobeamErrorResponse of(final String message, final SobeamErrorCode errorCode, HttpStatus status) {
        return new SobeamErrorResponse(message, errorCode, status);
    }
