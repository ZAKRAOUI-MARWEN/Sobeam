...
public interface TbAlarmCommentService {
    ...
    AlarmComment saveAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws SobeamException;

    void deleteAlarmComment(Alarm alarm, AlarmComment alarmComment, User user) throws SobeamException;
}
