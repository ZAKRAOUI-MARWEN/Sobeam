 ...
 */
package org.sobeam.server.service.entitiy.edge;
...
public class DefaultTbEdgeService extends AbstractTbEntityService implements TbEdgeService {
    ...
    @Override
    public Edge assignEdgeToCustomer(TenantId tenantId, EdgeId edgeId, Customer customer, User user) throws SobeamException {
    ...
    @Override
    public Edge unassignEdgeFromCustomer(Edge edge, Customer customer, User user) throws SobeamException {
    ...
    @Override
    public Edge assignEdgeToPublicCustomer(TenantId tenantId, EdgeId edgeId, User user) throws SobeamException {
        ActionType actionType = ActionType.ASSIGNED_TO_CUSTOMER;
