...
public interface TbOtaPackageService {
    ...
    OtaPackageInfo save(SaveOtaPackageInfoRequest saveOtaPackageInfoRequest, User user) throws SobeamException;
    ...
    void delete(OtaPackageInfo otaPackageInfo, User user) throws SobeamException;
