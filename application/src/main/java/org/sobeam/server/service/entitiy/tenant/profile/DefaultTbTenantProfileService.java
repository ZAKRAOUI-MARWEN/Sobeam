 ...
 */
package org.sobeam.server.service.entitiy.tenant.profile;
...
public class DefaultTbTenantProfileService extends AbstractTbEntityService implements TbTenantProfileService {
    ...
    @Override
    public TenantProfile save(TenantId tenantId, TenantProfile tenantProfile, TenantProfile oldTenantProfile) throws SobeamException {
    ...
    @Override
    public void delete(TenantId tenantId, TenantProfile tenantProfile) throws SobeamException {
