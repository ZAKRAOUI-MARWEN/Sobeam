...
import org.sobeam.server.common.data.notification.rule.trigger.TaskProcessingFailureTrigger;
...
import org.sobeam.server.queue.housekeeper.HousekeeperConfig;
import org.sobeam.server.queue.provider.TbCoreQueueFactory;
import org.sobeam.server.queue.util.AfterStartUp;
import org.sobeam.server.queue.util.TbCoreComponent;
import org.sobeam.server.service.housekeeper.processor.HousekeeperTaskProcessor;
import org.sobeam.server.service.housekeeper.stats.HousekeeperStatsService;
...
public class HousekeeperService {
    ...
    private final ExecutorService consumerExecutor = Executors.newSingleThreadExecutor(SoBeamThreadFactory.forName("housekeeper-consumer"));
    private final ExecutorService taskExecutor = Executors.newSingleThreadExecutor(SoBeamThreadFactory.forName("housekeeper-task-processor"));
