...
import org.sobeam.server.dao.util.NoSqlAnyDaoNonCloud;
...
* Then create tokens with database admin role and put it on Sobeam parameters.
* Without this service cloud DB will end up with exception like
* UnauthorizedException: Missing correct permission on sobeam
* */
@Service
@NoSqlAnyDaoNonCloud
@Profile("install")
