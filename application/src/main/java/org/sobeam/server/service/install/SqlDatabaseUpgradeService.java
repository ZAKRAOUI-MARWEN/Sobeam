...
import org.sobeam.server.service.install.update.DefaultDataUpdateService;
...
public class SqlDatabaseUpgradeService implements DatabaseEntitiesUpgradeService {
    ...
    private void loadSql(Path sqlFile, Connection conn) throws Exception {
        ...
        st.execute(sql);//NOSONAR, ignoring because method used to execute sobeam database upgrade script
        printWarnings(st);
        Thread.sleep(5000);
    }
