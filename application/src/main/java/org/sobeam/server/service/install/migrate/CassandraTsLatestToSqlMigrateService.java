 ...
 */
package org.sobeam.server.service.install.migrate;
...
import org.sobeam.server.common.data.UUIDConverter;
import org.sobeam.server.dao.cassandra.CassandraCluster;
import org.sobeam.server.dao.model.sqlts.dictionary.KeyDictionaryEntry;
import org.sobeam.server.dao.model.sqlts.dictionary.KeyDictionaryCompositeKey;
import org.sobeam.server.dao.model.sqlts.latest.TsKvLatestEntity;
import org.sobeam.server.dao.sqlts.dictionary.KeyDictionaryRepository;
import org.sobeam.server.dao.sqlts.insert.latest.InsertLatestTsRepository;
import org.sobeam.server.dao.util.NoSqlTsDao;
...
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.bigintColumn;
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.booleanColumn;
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.doubleColumn;
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.idColumn;
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.jsonColumn;
import static org.sobeam.server.service.install.migrate.CassandraToSqlColumn.stringColumn;
...
public class CassandraTsLatestToSqlMigrateService implements TsLatestMigrateService {
    ...
    public void migrate() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUserName, dbPassword)) {
            ...
            log.error("Unexpected error during SoBeam entities data migration!", e);
            throw e;
        }
    }
    ...
    private void loadSql(Path sqlFile, Connection conn) throws Exception {
        ...
        conn.createStatement().execute(sql); //NOSONAR, ignoring because method used to execute sobeam database upgrade script
        Thread.sleep(5000);
    }
}
