 ...
 */
package org.sobeam.server.service.ota;

import com.google.common.util.concurrent.FutureCallback;
import lombok.extern.slf4j.Slf4j;
import org.springframework.context.annotation.Lazy;
import org.springframework.stereotype.Service;
import org.sobeam.rule.engine.api.RuleEngineTelemetryService;
...
import org.sobeam.server.queue.provider.TbRuleEngineQueueFactory;
...
import static org.sobeam.server.common.data.ota.OtaPackageKey.CHECKSUM;
import static org.sobeam.server.common.data.ota.OtaPackageKey.CHECKSUM_ALGORITHM;
import static org.sobeam.server.common.data.ota.OtaPackageKey.SIZE;
import static org.sobeam.server.common.data.ota.OtaPackageKey.STATE;
import static org.sobeam.server.common.data.ota.OtaPackageKey.TAG;
import static org.sobeam.server.common.data.ota.OtaPackageKey.TITLE;
import static org.sobeam.server.common.data.ota.OtaPackageKey.TS;
import static org.sobeam.server.common.data.ota.OtaPackageKey.URL;
import static org.sobeam.server.common.data.ota.OtaPackageKey.VERSION;
import static org.sobeam.server.common.data.ota.OtaPackageType.FIRMWARE;
import static org.sobeam.server.common.data.ota.OtaPackageType.SOFTWARE;
import static org.sobeam.server.common.data.ota.OtaPackageUtil.getAttributeKey;
import static org.sobeam.server.common.data.ota.OtaPackageUtil.getTargetTelemetryKey;
import static org.sobeam.server.common.data.ota.OtaPackageUtil.getTelemetryKey;
