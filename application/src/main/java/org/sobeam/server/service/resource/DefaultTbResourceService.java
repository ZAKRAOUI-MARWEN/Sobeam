...
import static org.sobeam.server.dao.device.DeviceServiceImpl.INCORRECT_TENANT_ID;
import static org.sobeam.server.dao.service.Validator.validateId;
import static org.sobeam.server.utils.LwM2mObjectModelUtils.toLwM2mObject;
import static org.sobeam.server.utils.LwM2mObjectModelUtils.toLwm2mResource;
...
public class DefaultTbResourceService extends AbstractTbEntityService implements TbResourceService {
    ...
    @Override
    public TbResource save(TbResource resource, User user) throws SobeamException {
