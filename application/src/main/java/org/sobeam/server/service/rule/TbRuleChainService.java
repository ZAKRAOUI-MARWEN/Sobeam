...
public interface TbRuleChainService extends SimpleTbEntityService<RuleChain> {
    ...
    RuleChain setRootRuleChain(TenantId tenantId, RuleChain ruleChain, User user) throws SobeamException;
    ...
    RuleChain assignRuleChainToEdge(TenantId tenantId, RuleChain ruleChain, Edge edge, User user) throws SobeamException;

    RuleChain unassignRuleChainFromEdge(TenantId tenantId, RuleChain ruleChain, Edge edge, User user) throws SobeamException;

    RuleChain setEdgeTemplateRootRuleChain(TenantId tenantId, RuleChain ruleChain, User user) throws SobeamException;

    RuleChain setAutoAssignToEdgeRuleChain(TenantId tenantId, RuleChain ruleChain, User user) throws SobeamException;

    RuleChain unsetAutoAssignToEdgeRuleChain(TenantId tenantId, RuleChain ruleChain, User user) throws SobeamException;
