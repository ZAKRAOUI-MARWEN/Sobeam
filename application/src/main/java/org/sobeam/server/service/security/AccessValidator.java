 ...
 */
package org.sobeam.server.service.security;
...
import org.sobeam.server.controller.HttpValidationCallback;
...
import org.sobeam.server.exception.ToErrorResponseEntity;
...
public class AccessValidator {
    ...
    public void initExecutor() {
        executor = Executors.newSingleThreadExecutor(SoBeamThreadFactory.forName("access-validator"));
    }
    ...
    public DeferredResult<ResponseEntity> validateEntityAndCallback(SecurityUser currentUser, Operation operation, String entityType, String entityIdStr,
                                                                    ThreeConsumer<DeferredResult<ResponseEntity>, TenantId, EntityId> onSuccess) throws SobeamException {
    ...
    public DeferredResult<ResponseEntity> validateEntityAndCallback(SecurityUser currentUser, Operation operation, String entityType, String entityIdStr,
                                                                    ...
                                                                    BiConsumer<DeferredResult<ResponseEntity>, Throwable> onFailure) throws SobeamException {
