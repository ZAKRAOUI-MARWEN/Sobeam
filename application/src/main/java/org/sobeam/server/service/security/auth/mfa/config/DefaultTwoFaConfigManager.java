 ...
 */
package org.sobeam.server.service.security.auth.mfa.config;
...
import org.sobeam.server.dao.settings.AdminSettingsDao;
...
public class DefaultTwoFaConfigManager implements TwoFaConfigManager {
    ...
    @Override
    public PlatformTwoFaSettings savePlatformTwoFaSettings(TenantId tenantId, PlatformTwoFaSettings twoFactorAuthSettings) throws SobeamException {
