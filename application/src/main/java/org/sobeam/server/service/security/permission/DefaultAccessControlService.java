 ...
 */
package org.sobeam.server.service.security.permission;
...
public class DefaultAccessControlService implements AccessControlService {
    ...
    @Override
    public void checkPermission(SecurityUser user, Resource resource, Operation operation) throws SobeamException {
    ...
    public <I extends EntityId, T extends HasTenantId> void checkPermission(SecurityUser user, Resource resource,
                                                                                            Operation operation, I entityId, T entity) throws SobeamException {
        PermissionChecker permissionChecker = getPermissionChecker(user.getAuthority(), resource);
    ...
    private PermissionChecker getPermissionChecker(Authority authority, Resource resource) throws SobeamException {
    ...
    private void permissionDenied() throws SobeamException {
