...
public class DefaultSmsService implements SmsService {
    ...
    protected int sendSms(String numberTo, String message) throws SobeamException {
        if (this.smsSender == null) {
            throw new SobeamException("Unable to send SMS: no SMS provider configured!", SobeamErrorCode.GENERAL);
        }
        return this.sendSms(this.smsSender, numberTo, message);
    }

    @Override
    public void sendSms(TenantId tenantId, CustomerId customerId, String[] numbersTo, String message) throws SobeamException {
    ...
    @Override
    public void sendTestSms(TestSmsRequest testSmsRequest) throws SobeamException {
    ...
    private int sendSms(SmsSender smsSender, String numberTo, String message) throws SobeamException {
        try {
    ...
    private SobeamException handleException(Exception exception) {
        String message;
        ...
        return new SobeamException(String.format("Unable to send SMS: %s", message),
