 ...
 */
package org.sobeam.server.utils;
...
import org.sobeam.server.common.data.lwm2m.LwM2mInstance;
import org.sobeam.server.common.data.lwm2m.LwM2mObject;
import org.sobeam.server.common.data.lwm2m.LwM2mResourceObserve;
...
import static org.sobeam.server.common.data.lwm2m.LwM2mConstants.LWM2M_SEPARATOR_SEARCH_TEXT;
...
public class LwM2mObjectModelUtils {
    ...
    public static void toLwm2mResource(TbResource resource) throws SobeamException {
        try {
            ...
            throw new SobeamException(e, SobeamErrorCode.GENERAL);
        }
