...
import org.sobeam.server.common.data.EdgeUpgradeInfo;
...
import org.sobeam.server.dao.edge.EdgeDao;
...
import org.sobeam.server.edge.imitator.EdgeImitator;
import org.sobeam.server.gen.edge.v1.AdminSettingsUpdateMsg;
...
import org.sobeam.server.gen.edge.v1.OAuth2UpdateMsg;
...
import org.sobeam.server.gen.edge.v1.UserUpdateMsg;
...
public class EdgeControllerTest extends AbstractControllerTest {
    ...
    public void setupEdgeTest() throws Exception {
        executor = MoreExecutors.listeningDecorator(SoBeamExecutors.newWorkStealingPool(8, getClass()));
        loginTenantAdmin();
    }
    ...
    public void testGetEdgeUpgradeInstructions() throws Exception {
        // UpdateInfo config is updating from Sobeam Update server
