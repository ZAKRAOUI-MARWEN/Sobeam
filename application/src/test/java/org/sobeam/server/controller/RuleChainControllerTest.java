...
import org.sobeam.rule.engine.action.TbCreateAlarmNode;
import org.sobeam.rule.engine.action.TbCreateAlarmNodeConfiguration;
import org.sobeam.rule.engine.metadata.TbGetRelatedAttributeNode;
import org.sobeam.rule.engine.metadata.TbGetRelatedDataNodeConfiguration;
...
import org.sobeam.server.dao.rule.RuleChainDao;
...
public class RuleChainControllerTest extends AbstractControllerTest {
    ...
    public void testSaveRuleChainMetadataWithVersionedNodes() throws Exception {
        ...
        var annotation = TbGetRelatedAttributeNode.class.getAnnotation(org.sobeam.rule.engine.api.RuleNode.class);
