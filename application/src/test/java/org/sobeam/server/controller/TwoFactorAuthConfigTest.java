...
import org.sobeam.server.service.security.auth.mfa.provider.impl.OtpBasedTwoFaProvider;
import org.sobeam.server.service.security.auth.mfa.provider.impl.TotpTwoFaProvider;
...
public class TwoFactorAuthConfigTest extends AbstractControllerTest {
    ...
    public void testSubmitTotpTwoFaAccountConfig_validationError() throws Exception {
        ...
        totpTwoFaAccountConfig.setAuthUrl("otpauth://totp/SoBeam%20(Tenant):tenant@sobeam.org?issuer=SoBeam+%28Tenant%29&secret=FUNBIM3CXFNNGQR6ZIPVWHP65PPFWDII");
