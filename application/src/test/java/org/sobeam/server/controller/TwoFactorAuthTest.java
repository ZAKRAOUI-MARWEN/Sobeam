...
import org.sobeam.server.common.data.security.model.mfa.account.TotpTwoFaAccountConfig;
...
import org.sobeam.server.common.data.security.model.mfa.provider.TotpTwoFaProviderConfig;
...
public class TwoFactorAuthTest extends AbstractControllerTest {
    ...
    @Test
    public void testAuthWithoutTwoFaAccountConfig() throws SobeamException {
        configureTotpTwoFa();
    ...
    public void testTwoFa_multipleProviders() throws Exception {
        ...
        twoFaUser.setEmail("2fa@sobeam.org");
    ...
    private TotpTwoFaAccountConfig configureTotpTwoFa(Consumer<PlatformTwoFaSettings>... customizer) throws SobeamException {
        TotpTwoFaProviderConfig totpTwoFaProviderConfig = new TotpTwoFaProviderConfig();
        totpTwoFaProviderConfig.setIssuerName("tb");
    ...
    private SmsTwoFaAccountConfig configureSmsTwoFa(Consumer<SmsTwoFaProviderConfig>... customizer) throws SobeamException {
        SmsTwoFaProviderConfig smsTwoFaProviderConfig = new SmsTwoFaProviderConfig();
        smsTwoFaProviderConfig.setVerificationCodeLifetime(60);
        smsTwoFaProviderConfig.setSmsVerificationMessageTemplate("${code}");
