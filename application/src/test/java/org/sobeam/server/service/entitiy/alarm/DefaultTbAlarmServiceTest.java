...
public class DefaultTbAlarmServiceTest {
    ...
    @Test
    public void testAck() throws SobeamException {
        var alarm = new Alarm();
    ...
    @Test
    public void testClear() throws SobeamException {
        var alarm = new Alarm();
    ...
    @Test
    public void testUnassignAlarm() throws SobeamException {
    ...
    @Test
    public void testUnassignDeletedUserAlarms() throws SobeamException {
        AlarmInfo alarm = new AlarmInfo();
        alarm.setId(new AlarmId(UUID.randomUUID()));
