...
import org.sobeam.rule.engine.api.notification.FirebaseService;
...
import org.sobeam.server.common.data.notification.NotificationRequestPreview;
...
import org.sobeam.server.common.data.notification.info.EntityActionNotificationInfo;
import org.sobeam.server.common.data.notification.rule.trigger.config.AlarmCommentNotificationRuleTriggerConfig;
import org.sobeam.server.common.data.notification.settings.MobileAppNotificationDeliveryMethodConfig;
import org.sobeam.server.common.data.notification.settings.NotificationSettings;
import org.sobeam.server.common.data.notification.settings.SlackNotificationDeliveryMethodConfig;
import org.sobeam.server.common.data.notification.settings.UserNotificationSettings;
import org.sobeam.server.common.data.notification.targets.MicrosoftTeamsNotificationTargetConfig;
import org.sobeam.server.common.data.notification.targets.NotificationTarget;
import org.sobeam.server.common.data.notification.targets.platform.AllUsersFilter;
...
import org.sobeam.server.common.data.notification.targets.slack.SlackConversation;
import org.sobeam.server.common.data.notification.targets.slack.SlackConversationType;
import org.sobeam.server.common.data.notification.targets.slack.SlackNotificationTargetConfig;
import org.sobeam.server.common.data.notification.template.DeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.EmailDeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.MicrosoftTeamsDeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.MicrosoftTeamsDeliveryMethodNotificationTemplate.Button.LinkType;
import org.sobeam.server.common.data.notification.template.MobileAppDeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.NotificationTemplate;
import org.sobeam.server.common.data.notification.template.NotificationTemplateConfig;
import org.sobeam.server.common.data.notification.template.SlackDeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.SmsDeliveryMethodNotificationTemplate;
import org.sobeam.server.common.data.notification.template.WebDeliveryMethodNotificationTemplate;
...
import org.sobeam.server.service.notification.channels.MicrosoftTeamsNotificationChannel;
...
public class NotificationApiTest extends AbstractNotificationApiTest {
    ...
    public void testNotificationUpdatesForSeveralUsers() throws Exception {
        ...
        for (int i = 1; i <= usersCount; i++) {
            ...
            user.setEmail("test-user-" + i + "@sobeam.org");
    ...
    public void testNotificationRequestPreview() throws Exception {
        ...
        for (int i = 0; i < customerUsersCount; i++) {
            ...
            customerUser.setEmail("other-customer-" + i + "@sobeam.org");
