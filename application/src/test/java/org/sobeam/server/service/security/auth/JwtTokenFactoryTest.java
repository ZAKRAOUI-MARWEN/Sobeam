 ...
 */
package org.sobeam.server.service.security.auth;
...
import org.sobeam.server.common.data.security.model.JwtToken;
import org.sobeam.server.dao.settings.AdminSettingsService;
import org.sobeam.server.service.security.auth.jwt.settings.DefaultJwtSettingsService;
import org.sobeam.server.service.security.auth.jwt.settings.DefaultJwtSettingsValidator;
...
import org.sobeam.server.service.security.model.token.AccessJwtToken;
...
public class JwtTokenFactoryTest {
    ...
    private SecurityUser createSecurityUser() {
        ...
        securityUser.setEmail("tenant@sobeam.org");
