...
import org.sobeam.rule.engine.debug.TbMsgGeneratorNode;
import org.sobeam.rule.engine.debug.TbMsgGeneratorNodeConfiguration;
...
public abstract class BaseExportImportServiceTest extends AbstractControllerTest {
    ...
    public void beforeEach() throws Exception {
        ...
        tenant1.setEmail("tenant1@sobeam.org");
    ...
    protected RuleChain createRuleChain(TenantId tenantId, String name, EntityId originatorId) {
        ...
        ruleNode2.setType(org.sobeam.rule.engine.metadata.TbGetAttributesNode.class.getName());
        ruleNode2.setConfigurationVersion(TbGetAttributesNode.class.getAnnotation(org.sobeam.rule.engine.api.RuleNode.class).version());
    ...
    protected RuleChain createRuleChain(TenantId tenantId, String name) {
        ...
        ruleNode1.setType(org.sobeam.rule.engine.metadata.TbGetAttributesNode.class.getName());
        ruleNode1.setConfigurationVersion(TbGetAttributesNode.class.getAnnotation(org.sobeam.rule.engine.api.RuleNode.class).version());
        ruleNode1.setDebugMode(true);
