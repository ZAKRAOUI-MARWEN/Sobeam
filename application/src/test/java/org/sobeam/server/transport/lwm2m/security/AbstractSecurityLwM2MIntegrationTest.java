 ...
 */
package org.sobeam.server.transport.lwm2m.security;
...
import org.sobeam.server.common.data.device.credentials.lwm2m.AbstractLwM2MClientSecurityCredential;
...
import org.sobeam.server.common.data.device.credentials.lwm2m.RPKBootstrapClientCredential;
import org.sobeam.server.common.data.device.credentials.lwm2m.X509BootstrapClientCredential;
...
import org.sobeam.server.common.data.device.profile.lwm2m.bootstrap.PSKLwM2MBootstrapServerCredential;
import org.sobeam.server.common.data.device.profile.lwm2m.bootstrap.RPKLwM2MBootstrapServerCredential;
import org.sobeam.server.common.data.device.profile.lwm2m.bootstrap.X509LwM2MBootstrapServerCredential;
...
import org.sobeam.server.transport.lwm2m.AbstractLwM2MIntegrationTest;
import org.sobeam.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState;
import org.sobeam.server.transport.lwm2m.Lwm2mTestHelper.LwM2MProfileBootstrapConfigType;
...
import static org.sobeam.server.transport.lwm2m.Lwm2mTestHelper.OBJECT_ID_1;
