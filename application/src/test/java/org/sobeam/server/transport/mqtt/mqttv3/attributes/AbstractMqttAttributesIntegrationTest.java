 ...
 */
package org.sobeam.server.transport.mqtt.mqttv3.attributes;
...
import org.sobeam.server.common.data.DynamicProtoUtils;
...
import org.sobeam.server.transport.mqtt.AbstractMqttIntegrationTest;
import org.sobeam.server.transport.mqtt.mqttv3.MqttTestCallback;
import org.sobeam.server.transport.mqtt.mqttv3.MqttTestSubscribeOnTopicCallback;
...
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_ATTRIBUTES_REQUEST_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_ATTRIBUTES_RESPONSE_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_ATTRIBUTES_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_CONNECT_TOPIC;
import static org.sobeam.server.common.data.query.EntityKeyType.CLIENT_ATTRIBUTE;
import static org.sobeam.server.common.data.query.EntityKeyType.SHARED_ATTRIBUTE;
