 ...
 */
package org.sobeam.server.transport.mqtt.mqttv3.telemetry.timeseries;
...
import static org.sobeam.server.common.data.device.profile.MqttTopics.DEVICE_TELEMETRY_SHORT_JSON_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.DEVICE_TELEMETRY_SHORT_PROTO_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.DEVICE_TELEMETRY_SHORT_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_CONNECT_TOPIC;
import static org.sobeam.server.common.data.device.profile.MqttTopics.GATEWAY_TELEMETRY_TOPIC;
