 ...
 */
package org.sobeam.server.transport.mqtt.sparkplug;
...
import org.sobeam.server.common.data.kv.*;
...
import static org.sobeam.server.transport.mqtt.util.sparkplug.MetricDataType.*;
import static org.sobeam.server.transport.mqtt.util.sparkplug.SparkplugMetricUtil.createMetric;
import static org.sobeam.server.transport.mqtt.util.sparkplug.SparkplugTopicUtil.NAMESPACE;
...
public abstract class AbstractMqttV5ClientSparkplugTest extends AbstractMqttIntegrationTest {
    ...
    protected void createdAddMetricValuePrimitiveTsKv(List<TsKvEntry> listTsKvEntry, List<String> listKeys,
                                                      SparkplugBProto.Payload.Builder dataPayload, long ts) throws SobeamException {
    ...
    private TsKvEntry createdAddMetricTsKvLong(SparkplugBProto.Payload.Builder dataPayload, String key, Object value,
                                               long ts, MetricDataType metricDataType) throws SobeamException {
    ...
    private void createdAddMetricTsKvJson(SparkplugBProto.Payload.Builder dataPayload, String key,
                                          ...
                                          List<String> listKeys) throws SobeamException {
