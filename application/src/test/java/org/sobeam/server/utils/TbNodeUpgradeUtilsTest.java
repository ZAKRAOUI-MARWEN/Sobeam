...
import org.sobeam.rule.engine.metadata.TbGetCustomerAttributeNode;
import org.sobeam.rule.engine.metadata.TbGetEntityDataNodeConfiguration;
import org.sobeam.server.common.data.rule.RuleNode;
import org.sobeam.server.service.component.RuleNodeClassInfo;
...
public class TbNodeUpgradeUtilsTest {
    ...
    public void testUpgradeRuleNodeConfigurationWithNullConfig() throws Exception {
        ...
        var annotation = mock(org.sobeam.rule.engine.api.RuleNode.class);
