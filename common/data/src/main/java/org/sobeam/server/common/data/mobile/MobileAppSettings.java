...
import org.sobeam.server.common.data.id.MobileAppSettingsId;
...
public class MobileAppSettings extends BaseData<MobileAppSettingsId> implements HasTenantId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Type of application: true means use default Sobeam app", example = "true")
