 ...
 */
package org.sobeam.server.queue.scheduler;
...
public class DefaultSchedulerComponent implements SchedulerComponent {
    ...
    @PostConstruct
    public void init() {
        this.schedulerExecutor = Executors.newSingleThreadScheduledExecutor(SoBeamThreadFactory.forName("queue-scheduler"));
    }
