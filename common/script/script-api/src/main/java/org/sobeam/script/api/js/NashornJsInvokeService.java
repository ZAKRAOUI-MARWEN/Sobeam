 ...
 */
package org.sobeam.script.api.js;
...
import org.sobeam.script.api.TbScriptException;
...
public class NashornJsInvokeService extends AbstractJsInvokeService {
    ...
    public void init() {
        super.init();
        jsExecutor = MoreExecutors.listeningDecorator(SoBeamExecutors.newWorkStealingPool(jsExecutorThreadPoolSize, "nashorn-js-executor"));
        if (useJsSandbox) {
            sandbox = NashornSandboxes.create();
            monitorExecutorService = SoBeamExecutors.newWorkStealingPool(monitorThreadPoolSize, "nashorn-js-monitor");
