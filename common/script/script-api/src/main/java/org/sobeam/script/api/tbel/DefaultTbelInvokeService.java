...
import org.sobeam.script.api.AbstractScriptInvokeService;
import org.sobeam.script.api.ScriptType;
...
public class DefaultTbelInvokeService extends AbstractScriptInvokeService implements TbelInvokeService {
    ...
    public void init() {
        ...
        executor = MoreExecutors.listeningDecorator(SoBeamExecutors.newWorkStealingPool(threadPoolSize, "tbel-executor"));
        try {
