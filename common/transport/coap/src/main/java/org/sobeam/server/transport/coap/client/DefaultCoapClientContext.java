 ...
 */
package org.sobeam.server.transport.coap.client;
...
import org.sobeam.server.coapserver.CoapServerContext;
import org.sobeam.server.coapserver.TbCoapTransportComponent;
...
import org.sobeam.server.common.data.device.data.PowerMode;
...
import org.sobeam.server.common.data.device.profile.CoapDeviceTypeConfiguration;
import org.sobeam.server.common.data.device.profile.DefaultCoapDeviceTypeConfiguration;
...
import org.sobeam.server.common.transport.DeviceDeletedEvent;
import org.sobeam.server.common.transport.DeviceProfileUpdatedEvent;
import org.sobeam.server.common.transport.DeviceUpdatedEvent;
import org.sobeam.server.common.transport.SessionMsgListener;
import org.sobeam.server.common.transport.TransportDeviceProfileCache;
...
import org.sobeam.server.transport.coap.CoapSessionMsgType;
import org.sobeam.server.transport.coap.CoapTransportContext;
import org.sobeam.server.transport.coap.TbCoapMessageObserver;
import org.sobeam.server.transport.coap.TransportConfigurationContainer;
import org.sobeam.server.transport.coap.adaptors.CoapTransportAdaptor;
import org.sobeam.server.transport.coap.callback.AbstractSyncSessionCallback;
import org.sobeam.server.transport.coap.callback.CoapNoOpCallback;
import org.sobeam.server.transport.coap.callback.CoapResponseCallback;
import org.sobeam.server.transport.coap.callback.CoapResponseCodeCallback;
