...
public class SecureClientNoAuth {
    ...
    private ExecutorService executor = Executors.newFixedThreadPool(1, SoBeamThreadFactory.forName(getClass().getSimpleName()));
    ...
    public static void main(String[] args) throws URISyntaxException {
        System.out.println("Usage: java -cp ... org.sobeam.server.transport.coap.client.SecureClientNoAuth " +
