 ...
 */
package org.sobeam.server.transport.coap.efento;
...
import org.sobeam.server.common.data.device.profile.EfentoCoapDeviceTypeConfiguration;
...
import org.sobeam.server.gen.transport.coap.ConfigProtos;
import org.sobeam.server.gen.transport.coap.DeviceInfoProtos;
import org.sobeam.server.gen.transport.coap.MeasurementTypeProtos;
import org.sobeam.server.gen.transport.coap.MeasurementsProtos;
import org.sobeam.server.transport.coap.AbstractCoapTransportResource;
import org.sobeam.server.transport.coap.CoapTransportContext;
import org.sobeam.server.transport.coap.callback.CoapDeviceAuthCallback;
import org.sobeam.server.transport.coap.callback.CoapEfentoCallback;
import org.sobeam.server.transport.coap.efento.utils.CoapEfentoUtils;
...
import static org.sobeam.server.transport.coap.CoapTransportService.CONFIGURATION;
import static org.sobeam.server.transport.coap.CoapTransportService.CURRENT_TIMESTAMP;
import static org.sobeam.server.transport.coap.CoapTransportService.DEVICE_INFO;
import static org.sobeam.server.transport.coap.CoapTransportService.MEASUREMENTS;
