 ...
 */
package org.sobeam.server.transport.lwm2m.bootstrap.store;
...
import org.sobeam.server.transport.lwm2m.bootstrap.secure.LwM2MBootstrapConfig;
import org.sobeam.server.transport.lwm2m.secure.LwM2mCredentialsSecurityInfoValidator;
import org.sobeam.server.transport.lwm2m.secure.TbLwM2MSecurityInfo;
import org.sobeam.server.transport.lwm2m.server.LwM2mSessionMsgListener;
...
import org.sobeam.server.transport.lwm2m.server.client.LwM2MAuthException;
...
import static org.sobeam.server.transport.lwm2m.server.uplink.LwM2mTypeServer.BOOTSTRAP;
    ...
    private LwM2MBootstrapConfig getParametersBootstrap(TbLwM2MSecurityInfo store) {
        ...
        if (lwM2MBootstrapConfig != null) {
            ...
            if (this.getValidatedSecurityMode(lwM2MBootstrapConfig)) {
                ...
                helper.sendParametersOnSobeamTelemetry(helper.getKvStringtoSobeam(LOG_LWM2M_TELEMETRY, logMsg), sessionInfo);
                return null;
            }
        }
