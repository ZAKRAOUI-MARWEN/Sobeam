...
import org.sobeam.server.transport.lwm2m.secure.TbLwM2MAuthorizer;
import org.sobeam.server.transport.lwm2m.secure.TbLwM2MDtlsCertificateVerifier;
import org.sobeam.server.transport.lwm2m.server.store.TbSecurityStore;
...
import static org.sobeam.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_UPDATE_COAP_RESOURCE;
