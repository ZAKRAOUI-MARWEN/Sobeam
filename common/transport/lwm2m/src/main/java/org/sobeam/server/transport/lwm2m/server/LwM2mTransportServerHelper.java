 ...
 */
package org.sobeam.server.transport.lwm2m.server;
...
import org.sobeam.server.common.data.util.TbDDFFileParser;
...
import static org.sobeam.server.gen.transport.TransportProtos.KeyValueType.BOOLEAN_V;
...
public class LwM2mTransportServerHelper {
    ...
    public void sendParametersOnSobeamAttribute(List<TransportProtos.KeyValueProto> result, SessionInfoProto sessionInfo) {
    ...
    public void sendParametersOnSobeamTelemetry(List<TransportProtos.KeyValueProto> kvList, SessionInfoProto sessionInfo) {
        sendParametersOnSobeamTelemetry(kvList, sessionInfo, null);
    }

    public void sendParametersOnSobeamTelemetry(List<TransportProtos.KeyValueProto> kvList, SessionInfoProto sessionInfo, @Nullable Map<String, AtomicLong> keyTsLatestMap) {
     ...
     */
    public List<TransportProtos.KeyValueProto> getKvStringtoSobeam(String key, String value) {
    ...
    public TransportProtos.KeyValueProto getKvAttrTelemetryToSobeam(ResourceModel.Type resourceType, String resourceName, Object value, boolean isMultiInstances) {
