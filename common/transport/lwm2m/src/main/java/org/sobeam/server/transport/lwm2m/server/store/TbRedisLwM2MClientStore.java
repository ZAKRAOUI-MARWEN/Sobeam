...
import static org.sobeam.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.deserialize;
import static org.sobeam.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.serialize;
