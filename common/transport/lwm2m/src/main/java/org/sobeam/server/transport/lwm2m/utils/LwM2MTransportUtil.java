 ...
 */
package org.sobeam.server.transport.lwm2m.utils;
...
import org.sobeam.server.transport.lwm2m.config.TbLwM2mVersion;
...
import org.sobeam.server.transport.lwm2m.server.client.ResourceValue;
import org.sobeam.server.transport.lwm2m.server.downlink.HasVersionedId;
...
import static org.sobeam.server.common.data.lwm2m.LwM2mConstants.LWM2M_SEPARATOR_KEY;
...
public class LwM2MTransportUtil {
    ...
    public static List<LwM2MBootstrapServerCredential> getBootstrapParametersFromSobeam(DeviceProfile deviceProfile) {
