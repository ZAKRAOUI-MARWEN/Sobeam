...
import org.sobeam.server.common.transport.config.ssl.SslCredentialsConfig;
...
public class MqttSslHandlerProvider {
    ...
    private TrustManager getX509TrustManager(TrustManagerFactory tmf) throws Exception {
        ...
        return new SobeamMqttX509TrustManager(x509Tm, transportService);
    }

    static class SobeamMqttX509TrustManager implements X509TrustManager {

        private final X509TrustManager trustManager;
        private final TransportService transportService;

        SobeamMqttX509TrustManager(X509TrustManager trustManager, TransportService transportService) {
