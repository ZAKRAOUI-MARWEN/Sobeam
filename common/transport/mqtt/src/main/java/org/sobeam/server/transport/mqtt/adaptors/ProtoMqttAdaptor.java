 ...
 */
package org.sobeam.server.transport.mqtt.adaptors;
...
import org.sobeam.server.transport.mqtt.session.MqttDeviceAwareSessionContext;

import java.util.Optional;

import static org.sobeam.server.common.data.device.profile.MqttTopics.DEVICE_SOFTWARE_FIRMWARE_RESPONSES_TOPIC_FORMAT;
