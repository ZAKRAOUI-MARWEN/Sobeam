...
import static org.sobeam.common.util.JacksonUtil.newArrayNode;
...
public class SparkplugMetricUtil {
    ...
    public static Optional<TransportProtos.KeyValueProto> fromSparkplugBMetricToKeyValueProto(String key, SparkplugBProto.Payload.Metric protoMetric) throws SobeamException {
            ...
            switch (metricDataType) {
                ...
                case UInt64:
                    if (protoMetric.hasIntValue()) {
                        ...
                        throw new SobeamException("Invalid value for " + MetricDataType.fromInteger(metricType).name() + " datatype " + metricType, SobeamErrorCode.INVALID_ARGUMENTS);
                    }
                case String:
                case Text:
                case UUID:
                ...
                case Unknown:
                default:
                    throw new SobeamException("Failed to decode: Unknown MetricDataType " + metricType, SobeamErrorCode.INVALID_ARGUMENTS);
            }
        } catch (Exception e) {
            log.error("", e);
            return Optional.empty();
    ...
    public static SparkplugBProto.Payload.Metric createMetric(Object value, long ts, String key, MetricDataType metricDataType) throws SobeamException {
        ...
        switch (metricDataType) {
            ...
            case Unknown:
                throw new SobeamException("Invalid value for MetricDataType " + metricDataType.name(), SobeamErrorCode.INVALID_ARGUMENTS);
        }
        return metric;
    }

    public static TransportProtos.TsKvProto getTsKvProto(String key, Object value, long ts) throws SobeamException {
        try {
            ...
            if (value instanceof String) {
                ...
                throw new SobeamException("Failed to convert device/node RPC command to TsKvProto for Sparkplug MQT msg: value [" + value + "]", SobeamErrorCode.INVALID_ARGUMENTS);
            }
    ...
    public static Optional<Object> validatedValueByTypeMetric(TransportProtos.KeyValueProto kv, MetricDataType metricDataType) throws SobeamException {
        if (kv.getTypeValue() <= 3) {
            ...
            throw new SobeamException("Invalid type KeyValueProto " + kv.toString() + " for MetricDataType " + metricDataType.name(), SobeamErrorCode.INVALID_ARGUMENTS);
        }
        return Optional.empty();
    }

    public static Optional<Object> validatedValuePrimitiveByTypeMetric(TransportProtos.KeyValueProto kv, MetricDataType metricDataType) throws SobeamException {
        ...
        if (valueOpt.isPresent()) {
            try {
                switch (metricDataType) {
                    ...
                    case Int32:
                        ...
                        try {
                            ...
                            throw new SobeamException("Invalid type value " + kv.toString() + " for MetricDataType "
                                    + metricDataType.name(), eInt, SobeamErrorCode.INVALID_ARGUMENTS);
                        }
                        // long
                    case UInt32:
                    case Int64:
                ...
                throw new SobeamException("Invalid type value " + kv.toString() + " for MetricDataType " + metricDataType.name(), e, SobeamErrorCode.INVALID_ARGUMENTS);
            }
        }
        return Optional.empty();
    }
