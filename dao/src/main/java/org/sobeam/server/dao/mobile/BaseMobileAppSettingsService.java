...
public class BaseMobileAppSettingsService extends AbstractCachedEntityService<TenantId, MobileAppSettings, MobileAppSettingsEvictEvent> implements MobileAppSettingsService {
    ...
    @Value("${mobileApp.googlePlayLink:https://play.google.com/store/apps/details?id=org.sobeam.demo.app}")
    private String googlePlayLink;
    @Value("${mobileApp.appStoreLink:https://apps.apple.com/us/app/sobeam-live/id1594355695}")
