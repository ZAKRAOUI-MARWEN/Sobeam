...
import org.sobeam.server.common.data.audit.ActionStatus;
import org.sobeam.server.common.data.audit.ActionType;
import org.sobeam.server.common.data.audit.AuditLog;
import org.sobeam.server.common.data.id.AuditLogId;
...
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ACTION_DATA_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ACTION_FAILURE_DETAILS_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ACTION_STATUS_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ACTION_TYPE_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_CUSTOMER_ID_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ENTITY_ID_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ENTITY_NAME_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_ENTITY_TYPE_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_TENANT_ID_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_USER_ID_PROPERTY;
import static org.sobeam.server.dao.model.ModelConstants.AUDIT_LOG_USER_NAME_PROPERTY;
