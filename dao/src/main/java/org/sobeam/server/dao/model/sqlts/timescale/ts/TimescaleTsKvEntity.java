 ...
 */
package org.sobeam.server.dao.model.sqlts.timescale.ts;
...
import org.sobeam.server.dao.model.sql.AbstractTsKvEntity;

import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_AVG;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_AVG_QUERY;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_COUNT;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_COUNT_QUERY;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_MAX;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_MAX_QUERY;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_MIN;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_MIN_QUERY;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_SUM;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FIND_SUM_QUERY;
import static org.sobeam.server.dao.sqlts.timescale.AggregationRepository.FROM_WHERE_CLAUSE;
