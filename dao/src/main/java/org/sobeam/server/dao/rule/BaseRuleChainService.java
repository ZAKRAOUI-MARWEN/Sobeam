...
import org.sobeam.server.common.data.plugin.ComponentClusteringMode;
...
import org.sobeam.server.common.data.util.ReflectionUtils;
import org.sobeam.server.dao.entity.AbstractEntityService;
import org.sobeam.server.dao.entity.EntityCountService;
...
import org.sobeam.server.dao.service.validator.RuleChainDataValidator;
...
import static org.sobeam.server.common.data.DataConstants.TENANT;
...
import static org.sobeam.server.dao.service.Validator.validatePageLink;
import static org.sobeam.server.dao.service.Validator.validatePositiveNumber;
import static org.sobeam.server.dao.service.Validator.validateString;
...
public class BaseRuleChainService extends AbstractEntityService implements RuleChainService {
    ...
    public static final String TB_RULE_CHAIN_INPUT_NODE = "org.sobeam.rule.engine.flow.TbRuleChainInputNode";
    @Autowired
        ...
        if (nodes != null) {
            ...
            if (ruleChainMetaData.getRuleChainConnections() != null) {
                for (RuleChainConnectionInfo nodeToRuleChainConnection : ruleChainMetaData.getRuleChainConnections()) {
                    ...
                    targetNode.setType("org.sobeam.rule.engine.flow.TbRuleChainInputNode");
    ...
    private void setSingletonMode(RuleNode ruleNode) {
        ...
        try {
            ComponentClusteringMode nodeConfigType = ReflectionUtils.getAnnotationProperty(ruleNode.getType(),
                    "org.sobeam.rule.engine.api.RuleNode", "clusteringMode");
