...
import org.sobeam.server.dao.model.sql.EdgeEntity;
import org.sobeam.server.dao.model.sql.EdgeInfoEntity;
...
public interface EdgeRepository extends JpaRepository<EdgeEntity, UUID> {
    ...
    @Query("SELECT new org.sobeam.server.dao.model.sql.EdgeInfoEntity(d, c.title, c.additionalInfo) " +
            "FROM EdgeEntity d " +
    ...
    @Query("SELECT new org.sobeam.server.dao.model.sql.EdgeInfoEntity(a, c.title, c.additionalInfo) " +
            "FROM EdgeEntity a " +
