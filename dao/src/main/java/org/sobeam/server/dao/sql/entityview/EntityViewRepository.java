 ...
 */
package org.sobeam.server.dao.sql.entityview;
...
import org.sobeam.server.dao.model.sql.EntityViewEntity;
import org.sobeam.server.dao.model.sql.EntityViewInfoEntity;
...
public interface EntityViewRepository extends JpaRepository<EntityViewEntity, UUID>, ExportableEntityRepository<EntityViewEntity> {
    ...
    @Query("SELECT new org.sobeam.server.dao.model.sql.EntityViewInfoEntity(e, c.title, c.additionalInfo) " +
