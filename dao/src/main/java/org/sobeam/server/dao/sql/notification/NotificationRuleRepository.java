...
import org.sobeam.server.dao.model.sql.NotificationRuleEntity;
import org.sobeam.server.dao.model.sql.NotificationRuleInfoEntity;
...
public interface NotificationRuleRepository extends JpaRepository<NotificationRuleEntity, UUID>, ExportableEntityRepository<NotificationRuleEntity> {
    ...
    String RULE_INFO_QUERY = "SELECT new org.sobeam.server.dao.model.sql.NotificationRuleInfoEntity(r, t.name, t.configuration) " +
