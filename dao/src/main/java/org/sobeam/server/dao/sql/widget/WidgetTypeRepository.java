 ...
 */
package org.sobeam.server.dao.sql.widget;
...
import org.sobeam.server.dao.model.sql.WidgetTypeDetailsEntity;
import org.sobeam.server.dao.model.sql.WidgetTypeEntity;
import org.sobeam.server.dao.model.sql.WidgetTypeIdFqnEntity;
...
public interface WidgetTypeRepository extends JpaRepository<WidgetTypeDetailsEntity, UUID>, ExportableEntityRepository<WidgetTypeDetailsEntity> {
    ...
    @Query("SELECT new org.sobeam.server.dao.model.sql.WidgetTypeIdFqnEntity(wtd.id, wtd.fqn) FROM WidgetTypeDetailsEntity wtd " +
