 ...
 */
package org.sobeam.server.dao.util;
...
import org.sobeam.server.dao.device.DeviceConnectivityInfo;
...
public class DeviceConnectivityUtil {
    ...
    public static final String MQTT_IMAGE = "sobeam/mosquitto-clients ";
    public static final String COAP_IMAGE = "sobeam/coap-clients ";
    ...
    public static Resource getGatewayDockerComposeFile(String baseUrl, DeviceConnectivityInfo properties, DeviceCredentials deviceCredentials, String mqttType) throws URISyntaxException {
        ...
        dockerComposeBuilder.append("  # SoBeam IoT Gateway Service Configuration\n");
        dockerComposeBuilder.append("  tb-gateway:\n");
        dockerComposeBuilder.append("    image: sobeam/tb-gateway\n");
        ...
        dockerComposeBuilder.append("      - tb-gw-config:/sobeam_gateway/config\n");
        dockerComposeBuilder.append("      - tb-gw-logs:/sobeam_gateway/logs\n");
        dockerComposeBuilder.append("      - tb-gw-extensions:/sobeam_gateway/extensions\n");
        dockerComposeBuilder.append("\n");
