 ...
 */
package org.sobeam.rest.client;
...
import org.sobeam.rest.client.utils.RestJsonConverter;
...
import org.sobeam.server.common.data.id.OAuth2ClientRegistrationTemplateId;
...
import static org.sobeam.server.common.data.StringUtils.isEmpty;
...
public class RestClient implements Closeable {
    ...
    private final ExecutorService service = SoBeamExecutors.newWorkStealingPool(10, getClass());
