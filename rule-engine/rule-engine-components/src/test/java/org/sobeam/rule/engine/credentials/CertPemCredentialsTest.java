 ...
 */
package org.sobeam.rule.engine.credentials;
...
import org.sobeam.common.util.SslUtil;
...
import static org.sobeam.rule.engine.credentials.CertPemCredentials.CERT_ALIAS_PREFIX;
import static org.sobeam.rule.engine.credentials.CertPemCredentials.PRIVATE_KEY_ALIAS;
...
public class CertPemCredentialsTest {
    ...
    public void testChainOfCertificates() throws Exception {
        ...
        Assertions.assertEquals("CN=*.sobeam.cloud, O=\"SoBeam, Inc.\", ST=New York, C=US",
