...
import org.sobeam.server.common.data.EntityFieldsData;
    ...
    public void givenUnsupportedEntityTypes_whenFindAsync_thenException() {
        for (var entityType : EntityType.values()) {
            if (!SUPPORTED_ENTITY_TYPES.contains(entityType)) {
                ...
                var expectedExceptionMsg = "org.sobeam.rule.engine.api.TbNodeException: Unexpected originator EntityType: " + entityType;
