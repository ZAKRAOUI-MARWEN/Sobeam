...
class SobeamHtml extends React.Component<JsonFormFieldProps, JsonFormFieldState> {
    ...
    render() {
        return (
            <SobeamAceEditor {...this.props} mode='html' onTidy={this.onTidyHtml} {...this.state}></SobeamAceEditor>
        );
    }
}

export default SobeamHtml;
