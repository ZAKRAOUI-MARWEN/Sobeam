...
export const ruleChainNodeClazz = 'org.sobeam.rule.engine.flow.TbRuleChainInputNode';
export const outputNodeClazz = 'org.sobeam.rule.engine.flow.TbRuleChainOutputNode';

const ruleNodeClazzHelpLinkMap = {
  'org.sobeam.rule.engine.filter.TbCheckRelationNode': 'ruleNodeCheckRelation',
  'org.sobeam.rule.engine.filter.TbCheckMessageNode': 'ruleNodeCheckExistenceFields',
  'org.sobeam.rule.engine.geo.TbGpsGeofencingFilterNode': 'ruleNodeGpsGeofencingFilter',
  'org.sobeam.rule.engine.filter.TbJsFilterNode': 'ruleNodeJsFilter',
  'org.sobeam.rule.engine.filter.TbJsSwitchNode': 'ruleNodeJsSwitch',
  'org.sobeam.rule.engine.filter.TbAssetTypeSwitchNode': 'ruleNodeAssetProfileSwitch',
  'org.sobeam.rule.engine.filter.TbDeviceTypeSwitchNode': 'ruleNodeDeviceProfileSwitch',
  'org.sobeam.rule.engine.filter.TbCheckAlarmStatusNode': 'ruleNodeCheckAlarmStatus',
  'org.sobeam.rule.engine.filter.TbMsgTypeFilterNode': 'ruleNodeMessageTypeFilter',
  'org.sobeam.rule.engine.filter.TbMsgTypeSwitchNode': 'ruleNodeMessageTypeSwitch',
  'org.sobeam.rule.engine.filter.TbOriginatorTypeFilterNode': 'ruleNodeOriginatorTypeFilter',
  'org.sobeam.rule.engine.filter.TbOriginatorTypeSwitchNode': 'ruleNodeOriginatorTypeSwitch',
  'org.sobeam.rule.engine.metadata.TbGetAttributesNode': 'ruleNodeOriginatorAttributes',
  'org.sobeam.rule.engine.metadata.TbGetOriginatorFieldsNode': 'ruleNodeOriginatorFields',
  'org.sobeam.rule.engine.metadata.TbGetTelemetryNode': 'ruleNodeOriginatorTelemetry',
  'org.sobeam.rule.engine.metadata.TbGetCustomerAttributeNode': 'ruleNodeCustomerAttributes',
  'org.sobeam.rule.engine.metadata.TbGetCustomerDetailsNode': 'ruleNodeCustomerDetails',
  'org.sobeam.rule.engine.metadata.TbGetDeviceAttrNode': 'ruleNodeDeviceAttributes',
  'org.sobeam.rule.engine.metadata.TbGetRelatedAttributeNode': 'ruleNodeRelatedAttributes',
  'org.sobeam.rule.engine.metadata.TbGetTenantAttributeNode': 'ruleNodeTenantAttributes',
  'org.sobeam.rule.engine.metadata.TbGetTenantDetailsNode': 'ruleNodeTenantDetails',
  'org.sobeam.rule.engine.metadata.CalculateDeltaNode': 'ruleNodeCalculateDelta',
  'org.sobeam.rule.engine.transform.TbChangeOriginatorNode': 'ruleNodeChangeOriginator',
  'org.sobeam.rule.engine.transform.TbTransformMsgNode': 'ruleNodeTransformMsg',
  'org.sobeam.rule.engine.mail.TbMsgToEmailNode': 'ruleNodeMsgToEmail',
  'org.sobeam.rule.engine.action.TbAssignToCustomerNode': 'ruleNodeAssignToCustomer',
  'org.sobeam.rule.engine.action.TbUnassignFromCustomerNode': 'ruleNodeUnassignFromCustomer',
  'org.sobeam.rule.engine.action.TbClearAlarmNode': 'ruleNodeClearAlarm',
  'org.sobeam.rule.engine.action.TbCreateAlarmNode': 'ruleNodeCreateAlarm',
  'org.sobeam.rule.engine.action.TbCreateRelationNode': 'ruleNodeCreateRelation',
  'org.sobeam.rule.engine.action.TbDeleteRelationNode': 'ruleNodeDeleteRelation',
  'org.sobeam.rule.engine.delay.TbMsgDelayNode': 'ruleNodeMsgDelay',
  'org.sobeam.rule.engine.debug.TbMsgGeneratorNode': 'ruleNodeMsgGenerator',
  'org.sobeam.rule.engine.geo.TbGpsGeofencingActionNode': 'ruleNodeGpsGeofencingEvents',
  'org.sobeam.rule.engine.action.TbLogNode': 'ruleNodeLog',
  'org.sobeam.rule.engine.rpc.TbSendRPCReplyNode': 'ruleNodeRpcCallReply',
  'org.sobeam.rule.engine.rpc.TbSendRPCRequestNode': 'ruleNodeRpcCallRequest',
  'org.sobeam.rule.engine.telemetry.TbMsgAttributesNode': 'ruleNodeSaveAttributes',
  'org.sobeam.rule.engine.telemetry.TbMsgTimeseriesNode': 'ruleNodeSaveTimeseries',
  'org.sobeam.rule.engine.action.TbSaveToCustomCassandraTableNode': 'ruleNodeSaveToCustomTable',
  'org.sobeam.rule.engine.aws.sns.TbSnsNode': 'ruleNodeAwsSns',
  'org.sobeam.rule.engine.aws.sqs.TbSqsNode': 'ruleNodeAwsSqs',
  'org.sobeam.rule.engine.kafka.TbKafkaNode': 'ruleNodeKafka',
  'org.sobeam.rule.engine.mqtt.TbMqttNode': 'ruleNodeMqtt',
  'org.sobeam.rule.engine.mqtt.azure.TbAzureIotHubNode': 'ruleNodeAzureIotHub',
  'org.sobeam.rule.engine.rabbitmq.TbRabbitMqNode': 'ruleNodeRabbitMq',
  'org.sobeam.rule.engine.rest.TbRestApiCallNode': 'ruleNodeRestApiCall',
  'org.sobeam.rule.engine.mail.TbSendEmailNode': 'ruleNodeSendEmail',
  'org.sobeam.rule.engine.sms.TbSendSmsNode': 'ruleNodeSendSms',
  'org.sobeam.rule.engine.edge.TbMsgPushToCloudNode': 'ruleNodePushToCloud',
  'org.sobeam.rule.engine.edge.TbMsgPushToEdgeNode': 'ruleNodePushToEdge',
  'org.sobeam.rule.engine.flow.TbRuleChainInputNode': 'ruleNodeRuleChain',
  'org.sobeam.rule.engine.flow.TbRuleChainOutputNode': 'ruleNodeOutputNode',
  'org.sobeam.rule.engine.math.TbMathNode': 'ruleNodeMath',
  'org.sobeam.rule.engine.rest.TbSendRestApiCallReplyNode': 'ruleNodeRestCallReply',
};
